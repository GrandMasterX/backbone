...
class CustomVKontakteService extends VKontakteOAuthService {
	...
	protected $scope = 'notify,nickname,sex,bdate,city,country,timezone,photo,photo_medium,photo_big,photo_rec,friends';
	...
	protected function fetchAttributes() {
		$info = (array)$this->makeSignedRequest('https://api.vk.com/method/users.get.json', array(
			'query' => array(
				...
				'fields' => 'notify,nickname,sex,bdate,city,country,timezone,photo,photo_medium,photo_big,photo_rec,friends',
			),
		));
		...
		$this->attributes['url'] = 'http://vk.com/id'.$info->uid;
                $this->attributes['scope'] = $this->scope;
