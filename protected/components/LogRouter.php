 ...
 * @since 1.0
 */
class LogRouter extends CApplicationComponent
{
    ...
    public function init()
    {
        ...
        SysLogger::getLogger()->attachEventHandler('onFlush',array($this,'collectLogs'));
    ...
    {
        ////echo "<pre>collectLogs<br>";    print_r($route);    die;
        $logger=SysLogger::getLogger();  ///Yii
