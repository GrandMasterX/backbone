<?php 
    if($models):?>
            <?php foreach($models as $model):?>
                ...
                <?php if($model->type==1):?>
                    <div class="portlet-header" style="display:none"><?php echo Yii::t('formula','Расчетная формула');?></div>
                <?php elseIf($model->type==2):?>
                    <div class="portlet-header" style="display:none"><?php echo Yii::t('formula','Оценочная формула (диапазонная)');?></div>
                <?php elseIf($model->type==3):?>
                    <div class="portlet-header" style="display:none"><?php echo Yii::t('formula','Оценочная формула (графическая)');?></div>                        
                <?php elseIf($model->type==4):?>
                    <div class="portlet-header" style="display:none"><?php echo Yii::t('formula','Цепочка');?></div>                      
                <?php endIf;?>
                    <div class="portlet-content">
                        <?php $form=$this->beginWidget('CActiveForm', array(
                                ...
                                <?php if($model->type==1):?>
                                    <?php $this->renderPartial('_formula_html',array(
                                        'model'=>$model, 
                                        'form'=>$form,
                                        'sizeList'=>$sizeList,
                                        )
                                ...
                                <?php if($model->type==2):?>
                                    <?php $this->renderPartial('_formulaRes_Front_html',array(
                                        'model'=>$model, 
                                        'form'=>$form,
                                        )
                                    );?>
                                ...
                                <?php if($model->type==4):?>
                                    <?php $this->renderPartial('_formulaParent_html',array(
                                        'model'=>$model, 
                                        'form'=>$form,
                                        'sizeList'=>$sizeList,
                                        )
                          ...
                          <?php foreach($model->children as $child):?>
                            ...
                            <?php endIf;?>
                                ...
                                <?php $form=$this->beginWidget('CActiveForm', array(
                                        ...
                                        <?php if($child->type==4):?>
                                            <?php $this->renderPartial('_formulaParent_Front_html',array(
                                                'model'=>$child, 
                                                'form'=>$form,
                                                )
                                            );?>
