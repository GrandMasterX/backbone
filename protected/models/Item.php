...
class Item extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('partner_id, price', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
            'translations'=>array(self::HAS_MANY,'ItemTranslation','id','index'=>'language_id'),
            ...
            'sizeList'=>array(self::HAS_MANY,'ItemSize', 'item_id','on'=>'sizeList.is_blocked=0'),
...
//                    $this->vsl=$this->iltwo-$this->il;
        ...
        parent::afterSave();
                ...
                if (!empty($this->copyTranslations)) {
                    foreach ($this->copyTranslations as $language_id => $translation) {
                        $new_translation=new ItemTranslation();
    ...
    {
        $temp=ItemType::model()->findByPk($type_id);
